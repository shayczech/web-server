...
| `userdata.sh`     | Instance bootstrap: Docker, CloudWatch Agent, clone repo, Nginx (static site) |
...
Instances serve static files from `site/p/` (recipes) via Nginx. `/` redirects to `/p/recipes`.
